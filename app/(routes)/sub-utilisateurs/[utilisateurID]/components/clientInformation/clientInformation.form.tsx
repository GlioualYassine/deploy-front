...
export const formSchema = z.object({
    ...
    identifiant : z.string().min(2,'L\'identifiant de l\'utilisateur doit contenir au moins 2 caractères.').max(50,'L\'identifiant de l\'utilisateur ne doit pas dépasser 50 caractères.'),
   // password optionnel 
    password : z.string().min(6,'Le mot de passe doit contenir au moins 6 caractères.').max(50,'Le mot de passe ne doit pas dépasser 50 caractères.').optional(),
})