...
export const formSchema = z.object({
  ...
  imeiAppareil: z.string().optional(),
  ...
  sim2Appareil: z
    .string()
    .optional()
    .refine((val) => val === undefined || val === "" || /^\d{0,15}$/.test(val), {
      message: "Le numéro de SIM2, s'il est fourni, doit contenir entre 6 et 15 chiffres.",
    }),
  smsEmailAppareil: z.string().optional(),
  vitesseMaxAppareil: z.string().optional(),
  ...
  nomVoiture: z.string().max(50, "Le nom de la voiture ne doit pas dépasser 50 caractères.").optional(),
  marqueVoiture: z.string().optional(),
  modeleVoiture: z.string().optional(),
  immatriculeVoiture: z.string().max(50, "Le numéro d'immatriculation de la voiture ne doit pas dépasser 50 caractères.").optional(),
